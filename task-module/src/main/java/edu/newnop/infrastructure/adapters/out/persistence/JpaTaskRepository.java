...
public interface JpaTaskRepository extends JpaRepository<TaskEntity, Long> {
    Page<TaskEntity> findAllByUserId(Long aLong, PageRequest pageRequest);
    ...
    Page<TaskEntity> findByUserIdAndSearchQuery(Long aLong, String searchQuery, PageRequest pageRequest);
